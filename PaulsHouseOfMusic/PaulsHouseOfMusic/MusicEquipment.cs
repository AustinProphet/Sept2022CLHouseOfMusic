...
namespace PaulsHouseOfMusic
{
    ...
    //inventory.Add(new MusicEquipment
    //{
    //    Name = "Gretsch Hollowbody Guitar",
    //    Price = 499.99
    //});
    //inventory.Add(new MusicEquipment
    //{
